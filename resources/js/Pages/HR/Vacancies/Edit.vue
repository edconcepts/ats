            ...
            <div class="mt-8 flow-root">
                <div class="-mx-4 -my-2 overflow-x-auto sm:-mx-6 lg:-mx-8">
                    <div class="inline-block min-w-full py-2 align-middle sm:px-6 lg:px-8">
                        ...
                        <form @submit.prevent="updateVacancy(vacancy)">
                                    ...
                                    <div class="px-4 sm:p-8 w-[400px] shrink-0">
                                        <div class="mt-2 flex flex-col gap-6">
                                            ...
                                            <div class="lg:col-span-1">
                                                ...
                                                <div class="relative">
<!--                                                    <select v-model="form.opleidingsniveau" class="w-full flex-1 border border-gray-200 text-gray-700 py-3 px-4 pr-8 rounded leading-tight focus:outline-none focus:bg-white focus:border-gray-500">-->
