        ...
        <div class="px-4 sm:px-6 lg:px-8">
            <div class="sm:flex sm:items-center">
                ...
                <div class="mt-4 sm:ml-16 sm:mt-0 sm:flex-none">
                    <Link :href="route('hr.statuses.create')" type="button" class="block rounded-md bg-red-600 px-3 py-2 text-center text-sm font-semibold text-white shadow-sm hover:bg-red-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-red-600">Status toevoegen</Link>
                </div>
            </div>
                            ...
                            <table class="min-w-full divide-y divide-gray-300">
                                ...
                                <tr v-for="status in statuses" :key="status.id">
                                    ...
                                    <td class="relative whitespace-nowrap py-4 pl-3 pr-4 text-right text-sm font-medium sm:pr-6">
                                        <Link :href="route('hr.statuses.edit',status)" class="text-red-600 hover:text-red-900"
